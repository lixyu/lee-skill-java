...
public class ConcurrentDateUtils {
    ...
    private static Date getYMD(Calendar c) throws ParseException {
        ...
        String day = String.valueOf(c.get(Calendar.DAY_OF_MONTH)).length() == 2 ? String.valueOf(c.get(Calendar.DAY_OF_MONTH)) : "0" + String.valueOf(c.get(Calendar.DAY_OF_MONTH));
